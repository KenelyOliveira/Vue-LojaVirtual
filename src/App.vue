    ...
    <main :class="{'orange-green': themeSwitched}">
      <div class="app-container">
        <header class="app-header dark-brown">
          <h1>My Pet Store</h1>
          <v-toolbar>
              <v-switch class="text" style="padding-top:25px;" label="Change theme" v-model="themeSwitched"></v-switch>
              <v-spacer></v-spacer>
              <v-toolbar-items class="hidden-sm-and-down">
              <v-btn flat to="/home">Home</v-btn>
              <v-btn flat to="/pets">Pets</v-btn>
...
export default {
  ...
  data() {
    return {
      themeSwitched: Header.themeSwitched ? Header.themeSwitched : false
    };
  }
};
</script>
